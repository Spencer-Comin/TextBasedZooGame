...
feelings = ['Admiration', 'Adoration', 'Aesthetic Appreciation', 'Amusement', 'Anger', 'Anxiety', 'Awe', 'Awkwardness',
            'Boredom', 'Calmness', 'Confusion', 'Craving', 'Disgust', 'Empathetic pain', 'Entrancement', 'Excitement',
            'Fear', 'Horror', 'Interest', 'Joy', 'Annoyed', 'Nostalgia', 'Relief', 'Romance', 'Sadness', 'Satisfaction',
            'Sexual desire', 'Surprise']

facts = ['Gorillas can catch human colds and other illnesses.',
         ...
         'On average, dogs have better eyesight than humans, although not as colorful.', 'Deer have no gall bladders.',
         ...
         'The average fox weighs 14 pounds.', 'The scientific name of the red fox is Vulpes vulpes.',
         'Alligators generally live between 30 & 50 years.', 'A single elephant tooth can weigh as much as 9 pounds.',
         'The turkey is one of the most famous birds in North America.', 'A housefly hums in the key of F.',
         ...
         'Ants never sleep. Also they don’t have lungs.', 'A group of owls is called a parliament.',
         ...
         'Cats have lived with people for only 7,000 years.', 'A black panther is really a black leopard.',
         'The honey bee has been around for 30 million years.', 'The dumbest dog in the world is the Afghan hounds.',
         'A cat has 32 muscles in each ear.',
         'A dog’s shoulder blades are unattached to the rest of the skeleton to allow greater flexibility for running.',
         'Tigers have striped skin as well as their fur.', 'Hippos can run faster than humans!',
         ...
         'A woodpecker can peck 20 times per second.', 'The great horned owl has no sense of smell.',
         ...
         'Reindeer milk has more fat than cow milk.', 'Goats and sheep are seasonal breeders.',
         'An elephant can smell water up to 3 miles away.', 'Deer can’t eat hay.',
         ...
         'Lonomia obliqua is the world’s deadliest caterpillar.', '‘Jaws’ is the most common name for a goldfish.',
         ...
         'Dogs have sweat glands in between their paws.', 'The fear of animals is called zoophobia.',
         'We share 70% of our DNA with a slug.', 'We share 98.4% of our DNA with a chimp.',
         ...
         'A whale’s heart beats only nine times a minute.', 'Elephants are covered with hair.',
         ...
         'A rodent’s teeth never stop growing.', 'When young abalones feed on red seaweed their shells turn red.',
         'Small quantities of grapes and raisins can cause renal failure in dogs.',
         'The hippopotamus is born underwater.', 'Taurophobia is the fear of bulls.',
         ...
         'A large group of goats is called a herd.', 'Squirrels cannot see the color red.',
         'The average chicken lays about 260 eggs per year.', 'A starving mouse will eat its own tail.',
         'Only 5 to 10 percent of cheetah cubs make it to adulthood.', 'Ferrets sleep around 20 hours a day.',
         ...
         'Sharks are immune to cancer!', 'Worldwide, more people eat and drink milk from goats than any other animal.',
         ...
         'The sperm whale is the loudest animal. Their clicks have been measured at 230 dB.', 'Hippo’s sweat is pink.',
         ...
         'In the Caribbean there are oysters that can climb trees.', 'The swan has over 25,000 feathers in its body.',
         'The blue whale is the largest of all whales and is also considered the largest animal to have ever existed in the world.',
         'Giraffes have no vocal cords.', 'Starfish have five eyes – one at the end of each leg.',
         ...
         'Turkeys have a poor sense of smell, but excellent sense of taste.', 'Cats can hear ultrasound.',
         'Tuna fish can swim 40 miles in a single day.', 'Bumblebees have hair on their eyes.',
         ...
         'A cheetahs lifespan is up to 12 years in the wild.', 'Shark corneas are being used in human eye transplants.',
         ...
         'Arachnophobia is the fear of spiders.', 'Polar bears are the world’s largest land predators.',
         ...
         '79% of pet owners sleep with their pets.', 'Two dogs were among the Titanic survivors.',
         ...
         'The average dog can run about 19 mph.', 'The owl has a small brain.', 'Snakes do not blink.',
         'A squid’s eye can get as big as a basketball.', 'A puppy is born blind, deaf, and toothless.',
         ...
         'Dogs have lived with humans for over 14,000 years.', 'There are 3,000 kinds of lice in the world.',
         'The life of a housefly is only 14 days.', 'The lifespan of 75% of wild birds is 6 months.',
         ...
         'A herd of unicorns is called a blessing.', 'The oldest recorded elephant lived for 82 years.',
         ...
         'Cows from different areas have a different moo accent.', 'The male goat is called a “buck” or “billy”.',
         'The female goat is called a “doe” or “nanny”.', 'A baby goat is called a “kid”.',
         'Dog nose prints are as unique as human finger prints and can be used to identify them.',
         'Ailurophobia is the fear of cats.', 'Ichthyophobia is the fear of fish.',
         'Female bald eagles are 25% larger than males.',
         'Frogs don’t drink water. They absorb water through their skin.', 'Suriphobia is the fear of mice.',
         'There are over 210 breeds of goats in the world.', 'A polar bear’s outer fur is called ‘guard hair’.',
         ...
         'There are approximately 450 million goats around the world.', 'Dalmatians are completely white at birth.',
         'A beaver’s teeth never stop growing.', 'Apiphobia is the fear of bees.',
         ...
         'Crocodiles eat stones.', 'Crocodiles have brains no larger than a cigar.',
         'Cheetahs were trained by man for hunting as long as 3000 BC.', 'Horses can’t vomit.',
         'Both male and female caribou grow antlers.',
         'Alternate American names for the Elk are the moose and the Wapiti.', 'A group of frogs is called an army.',
         'Tigers can see 6 times better at night than humans.', 'Starfish don’t die of old age.',
         'A male gorilla can eat 40 pounds of food a day.', 'A group of whales is called a pod.',
         'Female harp seals get in groups to have their babies one mating season is over.',
         'When giraffes age, their fur darkens.', 'Heron’s eggs have a greenish-blue pale color.',
         ...
         'Tiger Day is the last Sunday in September.', 'There is no visual difference between male and female herons.',
         'A full-grown bear can run as fast as a horse.', 'Hyenas regularly eat the faeces of other animals.',
         'Frogs cannot swallow without blinking.', 'A giraffe has the same number of bones in its neck as a man.',
         'Moose have very poor vision. Some have even tried to mate with cars.',
         'The swan has over 25,000 feathers on its body.', 'African elephants have bigger ears than Indian elephants.',
         'There is no record of a human being attacked by a healthy wolf.',
         'Hummingbirds are the only birds who can fly backwards.', 'Dolphins can eat up to 30 pounds of fish a day.',
         ...
         'Jellyfish evaporate in the sun. They’re 98% water.', 'Rooster is simply a male chicken.',
         'Pikachu is a mouse type Pokémon.', 'Some lions mate over 50 times a day.',
